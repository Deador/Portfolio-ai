...
- `results`: массив переставлен и переписан — «-48%» (баги фронтенда от тестировщиков, 2024 vs 2025)
  поднят на первое место (единственный результат, целиком относящийся к работе дизайнера, вклад не
  делится); «18 → 2 дня» и «-48%» получили в описании методику замера; «+27%» понижен до `size: M`
...
- **Simbirsoft (Ак Барс банк)**: добавлен `roleNote: 'единственный дизайнер продукта'` (после правки —
  ...
  оторванной); добавлен третий буллет «Внедрил дизайн-ревью — –48% дефектов на фронте».
